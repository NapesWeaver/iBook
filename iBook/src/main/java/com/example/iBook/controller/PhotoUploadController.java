...
public class PhotoUploadController {
	private static final String uploadingDir = "/home/Jordi/uploads";
	...
	private void pipeStream(InputStream input, OutputStream output) throws Exception {
	...
	private void scaleImage(File inputFile, File output, int photoHeight, String ext) throws Exception {
		...
		ImageIO.write(rescaled,  ext, output);
	}	
}
